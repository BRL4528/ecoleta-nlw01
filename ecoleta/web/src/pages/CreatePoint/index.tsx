...
const CreatePoint = () => {
  ...
  const [ selecttedCity, setSelectedCity ] = useState('0')
  const [ selectedItems, setSelectedItems ] = useState<number[]>([]);
  const [ positionSelected, setPositionSelectd ] = useState<[number, number]>([0, 0])
  ...
  function handleSeleCity(event: ChangeEvent<HTMLSelectElement>) {
   ...
   async function handleSubmit(event: FormEvent) {
     ...
     const uf = selectedUf;
     const city = selecttedCity;
     const [ latitude, longitude ] = positionSelected;
     const items = selectedItems
     const latitute = latitude
